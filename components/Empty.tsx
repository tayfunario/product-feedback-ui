...
export default function Empty({ width }: { width: number }) {
  return width < 768 ? (
    <div className="flex justify-center items-center flex-col h-[28rem] bg-white rounded-lg mt-5 p-5">
      ...
      <p className="max-w-md text-[13px] text-center text-647 mt-5 mb-3">
    ...
    <div className="flex justify-center items-center flex-col h-[28rem] bg-white rounded-lg mt-5 p-5">
      <img src="/illustration-empty.svg" alt="empty" />
      <h1 className="h1-bold mt-10 text-3A4">There is no feedback yet.</h1>
      <p className="max-w-lg body-1 text-center text-647 mt-5 mb-3">
        Got a suggestion? Found a bug that needs to be squashed? We love hearing
        about new ideas to improve our app.
      </p>
      <button className="button-1 flex justify-center items-center my-2">
